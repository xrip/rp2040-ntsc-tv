...
This project demonstrates the use of the Pico's PWM and DMA peripherals to create a stable, color video output with minimal CPU intervention. The main application draws a scrolling black-and-white perspective checkerboard and a shaded ball that jumps between opposite corners while crossfading through six color ramps in a classic DOS demoscene style.
